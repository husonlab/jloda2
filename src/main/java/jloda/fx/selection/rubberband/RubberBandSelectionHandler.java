/*
 * RubberBandSelectionHandler.java Copyright (C) 2022 Daniel H. Huson
 *
...
public class RubberBandSelectionHandler {
     ...
     */
    public static RubberBandSelection.Handler create(PhyloGraph graph, SelectionModel<Node> nodeSelectionModel, SelectionModel<Edge> edgeSelectionModel, Function<Node, javafx.scene.Node> graphNodeSceneNodeMap) {
