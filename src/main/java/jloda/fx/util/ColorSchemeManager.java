/*
 * ColorSchemeManager.java Copyright (C) 2023 Daniel H. Huson
 *
...
public class ColorSchemeManager {
    ...
    public static final String[] BuiltInColorTables = {
            ...
            "Retro29;29;0Xf4d564;0X97141d;0Xe9af6b;0X82ae92;0X356c7c;0X5c8c83;0X3a2b27;0Xe28b90;0X242666;0Xc2a690;0Xb80614;0X35644f;0Xe3a380;" +
            "0Xb9a253;0X72a283;0X73605b;0X94a0ad;0Xf7a09d;0Xe5c09e;0X4a4037;0Xcec07c;0X6c80bb;0X7fa0a4;0Xb9805b;0Xd5c03f;0Xdd802e;0X8b807f;0Xc42030;0Xc2603d;" +
            "Glasbey29;29;#1E345A;#EA3323;#75FC4C;#EB33B1;#215313;#F8D548;#459CF8;#905146;#74FBC3;#7142BA;#489597;#F3B0F8;#B7CC7C;#DE315F;#EF9453;#CB2CF6;" +
            "#681153;#766C94;#4DAA3C;#D3FD51;#846D20;#F5BAA3;#85866A;#941D12;#73F5FD;#1B4798;#CE6692;#A0D2FA;#1B4CF6;"
            ...
            "Twenty;20;0x3061a0ff;0xea7231ff;0x4a9135ff;0xb92b2aff;0x7a50a9ff;0x71453dff;0xcb64b1ff;0x6c6c6cff;0xafb23fff;0x54afc1ff;0xa4b9deff;0xf1b071ff;0x9cd982ff;0xed8987ff;0xb49fc8ff;0xaf8c84ff;0xe7a7c6ff;0xbbbbbbff;0xd3d586ff;0x9dd0ddff;"
    };
        ...
        for (String table : tables) {
            ...
            if (tokens.length > 0) {
                ...
                while (i < tokens.length) {
                    ...
                    if (!colors.isEmpty() && !name2ColorSchemes.containsKey(name)) {
    ...
    public static void setPieChartColors(PieChart pieChart, String colorSchemeName) {
        var colorScheme = getInstance().getColorScheme(colorSchemeName);
        if (colorScheme != null) {
            pieChart.applyCss();
