/*
 * InfoMessage.java Copyright (C) 2023 Daniel H. Huson
 *
...
public class InfoMessage {
    ...
    public InfoMessage(Component parent, final String message, boolean echoToConsole) {
        if (ProgramProperties.isUseGUI()) {
			...
			JOptionPane.showMessageDialog(parent, StringUtils.toMessageString(message), label, JOptionPane.INFORMATION_MESSAGE, ProgramProperties.getProgramIcon());
            if (echoToConsole)
