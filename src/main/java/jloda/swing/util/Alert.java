/*
 * Alert.java Copyright (C) 2023 Daniel H. Huson
 *
...
public class Alert {
    ...
    public Alert(Component parent, final String message) {
        if (ProgramProperties.isUseGUI()) {
			...
			JOptionPane.showMessageDialog(parent, StringUtils.toMessageString(message), label, JOptionPane.ERROR_MESSAGE, ProgramProperties.getProgramIcon());
        } else
